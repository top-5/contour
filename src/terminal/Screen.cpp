...
// void Screen::shrinkColumns(Lines& _lines, int _cols, bool _reflow) const
// {
//     Line::LineBuffer wrappedColumns;
//
//     auto i = _lines.begin();
//     auto e = _lines.end();
//
...
//                 line->insert(
//                     line.begin(),
//                     wrappedColumns.begin(),
//                     wrappedColumns.end()
//                 );
//             }
//             else
//             {
//                 // TODO: insert new line behind
//                 i = _lines.insert(i, Line(_cols, wrappedColumns));
//                 i->setWrapped(true);
//             }
//         }
//         wrappedColumns = i->reflow(_cols);
//         ++i;
//     }
// }
